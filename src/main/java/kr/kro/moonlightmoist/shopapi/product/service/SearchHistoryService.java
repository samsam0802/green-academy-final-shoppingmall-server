...
public interface SearchHistoryService {
    ...
    void searchAdd(Long userId, String sessionIdentifier, String keyword);
    //해당 사용자(회원 또는 비회원)의 최근 검색어 목록 가져오기
    List<SearchRecentKeywordResponseDTO> getRecentKeywordList(Long userId, String sessionIdentifier);
    //실시간 인기 검색어 목록 가져오기
